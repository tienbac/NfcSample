...
namespace TN.NFC.Core.PcscCore
{
    public class PcscProvider
    {
        ...
        public static string getScardErrMsg(long errCode)
        {
            switch ((uint)errCode)
            {
                case SCARD_F_public_ERROR:
                    return "An public consistency check failed";
                ...
                case SCARD_F_WAITED_TOO_LONG:
                    return "An public consistency timer has expired";
                ...
                case SCARD_F_COMM_ERROR:
                    return "An public communications error has been detected";

                case SCARD_F_UNKNOWN_ERROR:
                    return "An public error has been detected, but the source is unknown";
        ...
        public const uint SCARD_F_public_ERROR = 0x80100001;
