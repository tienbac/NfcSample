...
namespace TN.NFC.Core.PcscCore
{
    internal class PcscProvider
    {
        ...
        internal const int SCARD_ATR_LENGTH = 33;
        internal const string winscardDLLFName = "winscard.dll";

        internal static string getScardErrMsg(long errCode)
        {
            switch ((uint)errCode)
            {
        ...
        internal const int CT_MCU = 0x00;                   // MCU
        internal const int CT_IIC_Auto = 0x01;               // IIC (Auto Detect Memory Size)
        internal const int CT_IIC_1K = 0x02;                 // IIC (1K)
        internal const int CT_IIC_2K = 0x03;                 // IIC (2K)
        internal const int CT_IIC_4K = 0x04;                 // IIC (4K)
        internal const int CT_IIC_8K = 0x05;                 // IIC (8K)
        internal const int CT_IIC_16K = 0x06;                // IIC (16K)
        internal const int CT_IIC_32K = 0x07;                // IIC (32K)
        internal const int CT_IIC_64K = 0x08;                // IIC (64K)
        internal const int CT_IIC_128K = 0x09;               // IIC (128K)
        internal const int CT_IIC_256K = 0x0A;               // IIC (256K)
        internal const int CT_IIC_512K = 0x0B;               // IIC (512K)
        internal const int CT_IIC_1024K = 0x0C;              // IIC (1024K)
        internal const int CT_AT88SC153 = 0x0D;              // AT88SC153
        internal const int CT_AT88SC1608 = 0x0E;             // AT88SC1608
        internal const int CT_SLE4418 = 0x0F;                // SLE4418
        internal const int CT_SLE4428 = 0x10;                // SLE4428
        internal const int CT_SLE4432 = 0x11;                // SLE4432
        internal const int CT_SLE4442 = 0x12;                // SLE4442
        internal const int CT_SLE4406 = 0x13;                // SLE4406
        internal const int CT_SLE4436 = 0x14;                // SLE4436
        internal const int CT_SLE5536 = 0x15;                // SLE5536
        internal const int CT_MCUT0 = 0x16;                  // MCU T=0
        internal const int CT_MCUT1 = 0x17;                  // MCU T=1
        internal const int CT_MCU_Auto = 0x18;               // MCU Autodetect
        ...
        /// </summary>
        internal const int SCARD_STATE_UNAWARE = 0x00;

        /// <summary>
        /// The application requested that this reader be ignored. No other
        /// bits will be set.
        /// </summary>
        internal const int SCARD_STATE_IGNORE = 0x01;
        ...
        /// </summary>
        internal const int SCARD_STATE_CHANGED = 0x02;
        ...
        /// </summary>
        internal const int SCARD_STATE_UNKNOWN = 0x04;
        ...
        /// </summary>
        internal const int SCARD_STATE_ATRMATCH = 0x40;
        ...
        /// </summary>
        internal const int SCARD_STATE_EXCLUSIVE = 0x80;
        ...
        /// </summary>
        internal const int SCARD_STATE_INUSE = 0x100;

        /// <summary>
        /// This implies that the card in the reader is unresponsive or not
        /// supported by the reader or software.
        /// </summary>
        internal const int SCARD_STATE_MUTE = 0x200;

        /// <summary>
        /// This implies that the card in the reader has not been powered up. 
        /// </summary>
        internal const int SCARD_STATE_UNPOWERED = 0x400;
        ...
        internal const long FILE_DEVICE_SMARTCARD = 0x310000; // Reader action IOCTLs
        internal const long IOCTL_SMARTCARD_DIRECT = FILE_DEVICE_SMARTCARD + 2050 * 4;
        internal const long IOCTL_SMARTCARD_SELECT_SLOT = FILE_DEVICE_SMARTCARD + 2051 * 4;
        internal const long IOCTL_SMARTCARD_DRAW_LCDBMP = FILE_DEVICE_SMARTCARD + 2052 * 4;
        internal const long IOCTL_SMARTCARD_DISPLAY_LCD = FILE_DEVICE_SMARTCARD + 2053 * 4;
        internal const long IOCTL_SMARTCARD_CLR_LCD = FILE_DEVICE_SMARTCARD + 2054 * 4;
        internal const long IOCTL_SMARTCARD_READ_KEYPAD = FILE_DEVICE_SMARTCARD + 2055 * 4;
        internal const long IOCTL_SMARTCARD_READ_RTC = FILE_DEVICE_SMARTCARD + 2057 * 4;
        internal const long IOCTL_SMARTCARD_SET_RTC = FILE_DEVICE_SMARTCARD + 2058 * 4;
        internal const long IOCTL_SMARTCARD_SET_OPTION = FILE_DEVICE_SMARTCARD + 2059 * 4;
        internal const long IOCTL_SMARTCARD_SET_LED = FILE_DEVICE_SMARTCARD + 2060 * 4;
        internal const long IOCTL_SMARTCARD_LOAD_KEY = FILE_DEVICE_SMARTCARD + 2062 * 4;
        internal const long IOCTL_SMARTCARD_READ_EEPROM = FILE_DEVICE_SMARTCARD + 2065 * 4;
        internal const long IOCTL_SMARTCARD_WRITE_EEPROM = FILE_DEVICE_SMARTCARD + 2066 * 4;
        internal const long IOCTL_SMARTCARD_GET_VERSION = FILE_DEVICE_SMARTCARD + 2067 * 4;
        internal const long IOCTL_SMARTCARD_GET_READER_INFO = FILE_DEVICE_SMARTCARD + 2051 * 4;
        internal const long IOCTL_SMARTCARD_SET_CARD_TYPE = FILE_DEVICE_SMARTCARD + 2060 * 4;
        internal const long IOCTL_SMARTCARD_ACR128_ESCAPE_COMMAND = FILE_DEVICE_SMARTCARD + 2079 * 4;

        internal const long IOCTL_SMARTCARD_ENABLE_PIN_VERIFICATION = FILE_DEVICE_SMARTCARD + 2075 * 4;
        internal const long IOCTL_SMARTCARD_ENABLE_PIN_MODIFICATION = FILE_DEVICE_SMARTCARD + 2076 * 4;
        internal const long IOCTL_SMARTCARD_DISABLE_SECURE_PIN_ENTRY = FILE_DEVICE_SMARTCARD + 2077 * 4;
        internal const long IOCTL_SMARTCARD_GET_FIRMWARE_VERSION = FILE_DEVICE_SMARTCARD + 2078 * 4;
        internal const long IOCTL_SMARTCARD_DISPLAY_LCD_MESSAGE = FILE_DEVICE_SMARTCARD + 2079 * 4;
        internal const long IOCTL_SMARTCARD_READ_KEY = FILE_DEVICE_SMARTCARD + 2080 * 4;
        internal const long CM_IOCTL_GET_FEATURE_REQUEST = FILE_DEVICE_SMARTCARD + 3400 * 4;
        ...
        internal const uint INVALID_CARD_HANDLE = 6;
        ...
        /// </summary>
        internal const int SCARD_PROTOCOL_UNDEFINED = 0x00;

        /// <summary>
        /// T=0 is the active protocol.
        /// </summary>
        internal const int SCARD_PROTOCOL_T0 = 0x01;

        /// <summary>
        /// T=1 is the active protocol.
        /// </summary>
        internal const int SCARD_PROTOCOL_T1 = 0x02;

        /// <summary>
        /// Raw is the active protocol.
        /// </summary>
        internal const int SCARD_PROTOCOL_RAW = 0x10000;
        ...
        /// state of the reader.
        /// </summary>
        internal const int SCARD_UNKNOWN = 0;
        ...
        internal static extern int SCardEstablishContext(int dwScope, int pvReserved1, int pvReserved2, ref IntPtr phContext);
        ...
        /// <returns></returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardReleaseContext(IntPtr phContext);
        ...
        /// <returns></returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardConnect(IntPtr hContext, string szReaderName, int dwShareMode, int dwPrefProtocol, ref IntPtr phCard, ref int activeProtocol);
        ...
        /// <returns>This function returns different values depending on whether it succeeds or fails.</returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardDisconnect(IntPtr hCard, int Disposition);
        ...
        /// <returns>This function returns different values depending on whether it succeeds or fails.</returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardListReaderGroups(IntPtr hContext, ref string mzGroups, ref int pcchGroups);
        ...
        [DllImport(winscardDLLFName)]
        internal static extern int SCardStatus(IntPtr hCard, string szReaderName, ref int pcchReaderLen, ref int State, ref int Protocol, byte[] ATR, ref int ATRLen);
        ...
        internal static extern int SCardGetStatusChange(IntPtr hContext, int TimeOut, ref SCARD_READERSTATE ReaderState, int ReaderCount);
        ...
        /// <returns>This function returns different values depending on whether it succeeds or fails.</returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardEndTransaction(IntPtr hCard, int Disposition);

        [DllImport(winscardDLLFName)]
        internal static extern int SCardState(IntPtr hCard, ref uint State, ref uint Protocol, ref byte ATR, ref uint ATRLen);
        ...
        internal static extern int SCardTransmit(IntPtr hCard, ref SCARD_IO_REQUEST pioSendRequest, byte[] SendBuff, int SendBuffLen, ref SCARD_IO_REQUEST pioRecvRequest, byte[] RecvBuff, ref int RecvBuffLen);
        ...
        /// <returns>This function returns different values depending on whether it succeeds or fails.</returns>
        [DllImport(winscardDLLFName)]
        internal static extern int SCardControl(IntPtr hCard, uint dwControlCode, byte[] SendBuff, int SendBuffLen, [In, Out] byte[] RecvBuff, int RecvBuffLen, [In, Out] ref int pcbBytesReturned);


        [DllImport(winscardDLLFName)]
        internal static extern int SCardReconnect(IntPtr hContext, int dwShareMode, int dwPrefProtocol, int dwInitialization, ref int activeProtocol);
        ...
        /// <returns></returns>
        internal static string GetTagType(byte sel_Res)
        {
            switch (sel_Res)
            {
                case 0x00:
